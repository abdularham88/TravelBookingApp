...
import img from "./images/Taj-Mahal-in-Agra-Uttar-Pradesh-in-India-Source-Canva-2.webp";
import img2 from "./images/b6bjf304_san-marino_625x300_18_August_25.webp";
import img3 from "./images/pmpkfiv8_sheikh-zayed-grand-mosque_625x300_13_August_25.webp";
import img4 from "./images/Amber-Fort-in-Jaipur-Rajasthan-in-India-Source-Incredible-India.webp";
...
function About() {
  const images = [img, img2, img4];
  return (
    <>
      <div className="mx-auto w-full max-w-7xl">
        <h1 className="text-center font-bold text-4xl pt-10 ">About Us</h1>
            ...
            {images.map((src, i) => (
              <SwiperSlide key={i}>
                <img
                  src={src}
                  alt={`Slide ${i}`}
                  className="rounded-lg w-full h-4/5"
                />
              </SwiperSlide>
            ))}
          </Swiper>
        ...
        <div className=" mx-15 place-items-center sm:mt-20">
          <h1 className=" text-xl sm:text-2xl py-5 font-light">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum,
            illum nostrum! Aperiam, necessitatibus et libero suscipit hic
            temporibus vel nihil harum, non ipsam sunt? Corrupti, eum officia.
            Sed, assumenda ex! Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora quod harum totam magni sunt veniam veritatis aliquam, a numquam, aspernatur ratione nesciunt maxime expedita! Quas corrupti sit aliquid deleniti rem officia ex vitae repellendus explicabo pariatur. Maxime ducimus natus doloribus impedit? Dicta ipsa minima expedita atque, porro similique officia quam cumque natus fuga animi quibusdam veritatis ad obcaecati fugiat explicabo?
          </h1>
